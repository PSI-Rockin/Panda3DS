...
void NullFrontend::resetAudioPipe() {
...
bool NullFrontend::recvDataIsReady(u32 regId) {
	//Treat data as always ready
	return true;
}

void NullFrontend::setSemaphore(u16 value) {
	//NOP
}

void NullFrontend::writeProcessPipe(u32 channel, u32 size, u32 buffer) {
	...
	default:
		log("Audio::NullFrontend: Wrote to unimplemented pipe %d\n", channel);
		break;
	}
}

std::vector<u8> NullFrontend::readPipe(u32 pipe, u32 peer, u32 size, u32 buffer) {
...
void NullFrontend::unloadComponent() {
	//NOP
}

void NullFrontend::setSemaphoreMask(u16 value) {
	//NOP
}
